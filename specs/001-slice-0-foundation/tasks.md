...
| T012, T013 | [impl] | FR-009 | SC-005 | AC-041 | — | II *(the two manifests FR-009 actually names — Domain and Application)* |
...
| T029 | [impl] | FR-019, FR-020 | SC-008 | AC-043 | — | IV |
...
| T025 | [test], **PENDING** | FR-001, FR-018 | SC-007 | AC-039 | — | III (blocked — see Pending / Blocked Items) |
| T026 | [test], **PENDING** | FR-001, FR-018 | SC-001 | AC-039 | — | III (blocked — see Pending / Blocked Items) |
| T036, T037 | [impl] | FR-001, FR-018 | SC-001, SC-007 | AC-039 | — | III |
...
| T046 | [test] | FR-023 | SC-010 | — | PLT-011 | VII |
...
| T052 | [test], **PENDING** | FR-021 | SC-009 | AC-043 | — | IV, VI (blocked — see Pending / Blocked Items) |
| T053 | [test], **PENDING** | FR-022 | SC-009 | AC-033, AC-034 | SEC-001, SEC-003 | III, IV, VI (blocked) |
| T054 | [test], **PENDING** | FR-017, FR-022 | SC-009 | AC-038 | SEC-008 | IV, VI, VIII (blocked) |
| T055 | [impl] | FR-019 | — | AC-043 | — | IV |
| T056 | [impl] | FR-019, FR-020 | SC-008 | AC-043 | — | IV |
...
- Task count changed from **87 to 88** this pass: one task was added (T084, the human-maintainer checkpoint recording `SC-007`'s actual execution evidence, distinct from T083's documentation-only runbook). Every task from the old `T084` onward was renumbered by +1; every cross-reference in this file was updated to match.
